...
export default class UserValidators {
  /**
   * @return {Object} error object with errors arrays if user data is invalid
   */
  ...
  /**
   * @return {JSON} JSON error object if user contains invalid data
   * @return {next} - passes control to next function if all user data are valid
   * @param {*} req - Payload
  ...
  /**
   * @return {Object} error object with errors arrays if password change data is invalid
   */
  ...
  /**
   * @return {JSON} JSON error object if password creation contains invalid data
   * @return {next} - passes control to next function if all password creation data are valid
   * @param {*} req - Payload
   * @param {*} res - Response object
   * @param {*} next - Passes control to next function
   */
